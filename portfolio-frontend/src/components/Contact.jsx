...
const Contact = ({ theme, isDarkMode, data }) => {
      ...
      <div style={{ 
        ...
        >
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem' }}>
              {[
                  { label: 'Direct Inquiry', value: data?.email || 'email@example.com', icon: <Mail size={18} /> },
                  { label: 'Voice / WhatsApp', value: data?.mobile || '+91 0000000000', icon: <Phone size={18} /> },
                  { label: 'Current Base', value: data?.location || 'Punjab, India', icon: <MapPin size={18} /> }
              ].map((item, i) => (
