  ...
  return (
    ...
    >
      ...
      {index === 0 && (
          ...
          >
              <h2 style={{ fontSize: '3.5rem', fontWeight: 900, color: theme.text, fontFamily: 'var(--font-heading)', margin: 0 }}>Projects</h2>
          </motion.div>
      )}
      ...
      <div style={{ 
        ...
        <motion.div 
          ...
          style={{ flex: 1.5, minWidth: '450px', position: 'relative', transformStyle: 'preserve-3d', rotateX, rotateY }}
        >
          {/* Glass Frame */}
